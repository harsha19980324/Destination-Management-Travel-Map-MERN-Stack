...
export default class CreateDestination extends Component {
    ...
    onSubmit = (e) =>{   
        ...
        if(this.state.title && this.state.description && this.state.description1  && this.state.url  && this.state.url1 && this.state.image1 && !this.state.image1Error ){
    ...
    validation = () => {
        ...
        if (!this.state.description.length < 8) {
            descriptionError = 'The password provided is not long enough.'
        }
        ...
        if(!this.state.image1.includes('jpg','jpeg','png','gif')){
            image1Error="Image Required!"
        }
