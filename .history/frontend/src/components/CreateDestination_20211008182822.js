...
export default class CreateDestination extends Component {
    ...
    validation = () => {
        ...
        if(titleError | descriptionError | description1Error | cityError | provinceError | descriptionError | adventure_typeError ){
            ...
            this.setState({ titleError , descriptionError , image1Error , image2Error , provinceError , descriptionError , adventure_typeError});
