...
onDelete = (id) =>{
    axios.delete(`http://localhost:8000/destination/delete/${id}`).then((res)=>{
                            ...
                            <main>
                                <div className="row center">
                                      ...
                                      {this.state.destinations.map((destinations,index)=>(
                                        ...
                                        <img className="destination-medium" src={ "http://localhost:8000/" + destinations.image1 } alt="gjgjgj"/>
                                        </a>
