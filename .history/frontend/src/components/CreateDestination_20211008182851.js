...
export default class CreateDestination extends Component {
    ...
    validation = () => {
        ...
        if(titleError | descriptionError | description1Error | urlError | url1Error | descriptionError | adventure_typeError ){

            this.setState({ titleError , descriptionError , description1Error , urlError , url1Error , descriptionError , adventure_typeError });
