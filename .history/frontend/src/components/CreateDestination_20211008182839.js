...
export default class CreateDestination extends Component {
    ...
    validation = () => {
        ...
        if(titleError | descriptionError | description1Error | urlError | provinceError | descriptionError | adventure_typeError ){

            this.setState({ titleError , descriptionError , description1Error , urlError , provinceError , descriptionError , adventure_typeError });

            return false;
        }else{
            this.setState({ titleError , descriptionError , description1Error , image2Error , provinceError , descriptionError , adventure_typeError});
