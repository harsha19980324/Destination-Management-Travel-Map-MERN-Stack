...
export default class CreateDestination extends Component {
    ...
    validation = () => {
        ...
        if(titleError | descriptionError | image2Error | cityError | provinceError | descriptionError | adventure_typeError ){

            this.setState({ titleError , descriptionError , image1Error , image2Error , provinceError , descriptionError , adventure_typeError });

            return false;
        }else{
            this.setState({ titleError , cityError , image1Error , image2Error , provinceError , descriptionError , adventure_typeError});
